                    ...
                    children: [
                      ...
                      Expanded(
                          child: SingleChildScrollView(
                                                                      ...
                                                                      child: Container(
                                                                          ...
                                                                          child: RichText(
                                                                              text: TextSpan(children: [
                                                                                TextSpan(text: "lbl_up_to".tr.toUpperCase(), style: TextStyle(color: ColorConstant.whiteA7007f, fontSize: getFontSize(24), fontFamily: 'Lato', fontWeight: FontWeight.w500)),
                                                                                TextSpan(text: ' ', style: TextStyle(color: ColorConstant.gray900, fontSize: getFontSize(24), fontFamily: 'Lato', fontWeight: FontWeight.w500)),
                                                                                TextSpan(text: "lbl_60_off".tr.toUpperCase(), style: TextStyle(color: ColorConstant.gray200, fontSize: getFontSize(24), fontFamily: 'Lato', fontWeight: FontWeight.w500))
                                                                              ]),
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 87, right: 16),
                                child: Text(
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 36, right: 16),
                                child: CommonImageView(
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 27, right: 16),
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 12, right: 16),
                                child: Text("msg_raincoats_swea".tr,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style:
                                        AppStyle.txtLatoRegular12.copyWith())),
                            Padding(
                                padding:
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 64, right: 16),
                                child: Text(
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 49, right: 16),
                                child: Row(
                                    mainAxisAlignment:
                                        MainAxisAlignment.spaceBetween,
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                          ...
                                          child: CommonImageView(
                                              imagePath:
                                                  ImageConstant.imgBrandthree,
                                              height: getSize(40.00),
                                              width: getSize(40.00))),
                                      Padding(
                                          padding:
                                              getPadding(top: 9, bottom: 10),
                                          child: CommonImageView(
                                              imagePath:
                                                  ImageConstant.imgBrandfour,
                                                                      ...
                                                                      child: Padding(
                                                                          padding: getPadding(
                                                                              ...
                                                                              right:
                                                                                  10),
                                                                          child: ClipRRect(
                                                                              borderRadius: BorderRadius.only(topLeft: Radius.circular(getHorizontalSize(279.50)), topRight: Radius.circular(getHorizontalSize(279.50))),
                                                                              child: CommonImageView(imagePath: ImageConstant.imgImagesix, height: getVerticalSize(354.00), width: getHorizontalSize(292.00)))))
                                                                ])))
                                                  ])),
                                          CustomButton(
                                              width: 174,
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 68, right: 16),
                                child: Text(
                            ...
                            Padding(
                                padding:
                                    getPadding(left: 16, top: 51, right: 16),
                                child: CommonImageView(
