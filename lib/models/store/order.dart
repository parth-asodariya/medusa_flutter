import 'package:medusa_flutter/models/store/address.dart';
import 'package:medusa_flutter/models/store/cart.dart';
import 'package:medusa_flutter/models/store/claim_order.dart';
import 'package:medusa_flutter/models/store/currency.dart';
import 'package:medusa_flutter/models/store/customer.dart';
import 'package:medusa_flutter/models/store/discount.dart';
import 'package:medusa_flutter/models/store/draft_order.dart';
import 'package:medusa_flutter/models/store/fulfillment.dart';
import 'package:medusa_flutter/models/store/gift_card.dart';
import 'package:medusa_flutter/models/store/gift_card_transaction.dart';
import 'package:medusa_flutter/models/store/line_item.dart';
import 'package:medusa_flutter/models/store/payment.dart';
import 'package:medusa_flutter/models/store/refund.dart';
import 'package:medusa_flutter/models/store/region.dart';
import 'package:medusa_flutter/models/store/return.dart';
import 'package:medusa_flutter/models/store/sales_channel.dart';
import 'package:medusa_flutter/models/store/shipping_method.dart';
import 'package:medusa_flutter/models/store/swap.dart';
...
class Order {
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    if (json['gift_card_transactions'] != null) {
      ...
      json['gift_card_transactions'].forEach(
          (e) => giftCardTransactions!.add(GiftCardTransaction.fromJson(e)));
    }
